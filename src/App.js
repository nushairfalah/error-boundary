...
//       < CardBook titleComp={this.state.book.title} descComp={this.state.book.desc} authorComp={this.state.book.author} />
...
//     const checkAlpha = /^[a-zA-Z@]+$/;
//     if (event.target.value.match(checkAlpha)) {
//       this.setState(
...
//   //   this.setState(
//   //     {
//   //       (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 90 && event.charCode <= 122));
//   //     }
//   //   )
//   // }

//   submit = () => {
//     // this.state.age < 17 || this.state.age > 80
//     if (this.state.name === "" || this.state.age === "") {
//       alert("Input salah, jangan ada yg kosong");
...
//         <Age inputAge={this.state.age} changeAge={this.changeAgeHandler} />
//         <UserOutput name={this.state.name} inputAge={this.state.age} />
//         <Submit submitButton={this.submit} />
//       </div>
//     )
//   }
...
//     const indexAge = cards.findIndex(card => card.id === id)
//     const newAge = [...cards]
//     newAge[indexAge].age = event.target.value
//     setCards(newAge)
//   }
...
//   //   cards.map((card, index) => <Card name={card.name} title={card.title} avatar={card.avatar}>{buttonMarkup}</Card>)
//   // )
...
//   // if (cards.length < 5) buttonStyle.backgroundColor = 'red'

//   // Metode Styling 2
//   const classes = ['button']
//   if (cards.length > 5) classes.push('blue')
//   if (cards.length < 5) classes.push('red')
...
//       {/* {showCard && <Card>{buttonMarkup}</Card>} */}
//       {cardMarkup}
//     </div>
//   )
// }
...
// import InputTelepon from './inputTelepon';
...
//     const formNama = event.target.value
//     if (formNama.match(/^[A-Za-z]+$/)) {
//       setFormNama(formNama)
//     }
//   }

//   const changeAddressHandler = (event) => {
//     const formAlamat = event.target.value
//     setFormAlamat(formAlamat)
//   }

//   const changePhoneHandler = (event) => {
//     const formTelepon = event.target.value
//     if (formTelepon.match(/^[0-9]+$/)) {
//       setFormTelepon(formTelepon)
//     }
//   }

//   const disable = formNama.length < 5 || formAlamat.length < 5 || formTelepon.length < 8 || formTelepon.length > 12 ? true : false
...
//     <div className='App'>
//       <h2>Form</h2>
//       <InputNama inputNama={(event) => changeNameHandler(event)} />
//       <InputAlamat inputAlamat={(event) => changeAddressHandler(event)} />
//       <InputTelepon inputTelepon={(event) => changePhoneHandler(event)} />
//       <InputSubmit disableButton={disable} inputSubmit={() => buttonHandler()} />
//     </div>
//   )
...
function App() {
  return (
    <div className="App">
      ...
      <ErrorBoundary color="green">
        <BuggyCounter />
      </ErrorBoundary>
      <ErrorBoundary color="yellow">
        <BuggyCounter />
      </ErrorBoundary>
      <ErrorBoundary color="blue">
        <BuggyCounter />
      </ErrorBoundary>
